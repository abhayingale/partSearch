...
stopwords = set(stopwords.words("english"))
    ...
    #Master Data
dictionary = pd.read_csv('F:\AbhinavPy\part_matcher-master\Fuzzy.csv', header=None, squeeze=True).to_dict()
    
    #Second Master Data
with open('F:\AbhinavPy\part_matcher-master\Second_dict.csv', 'r') as read_obj:
...
def CalculatedSearchData(SearchData):
    ...
    clean_doc =[]    
    test_line =[]
    #file_docs = ['WIRING HARNESS,AEBS FRAME (45WB) (264254621603)']
    file_docs = []
